...
```bash
npx create-next-app --example with-typescript-tailwindcss with-tailwindcss-app
# or
yarn create next-app --example with-typescript-tailwindcss with-tailwindcss-app
```
